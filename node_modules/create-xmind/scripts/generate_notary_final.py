...
def build_xmind_data():
    ...
    branches.append({
        ...
        "children": [
            ...
            {"title": "1.2 正向测试用例", "children": [
                {
                    "title": "DAT-01：正常发起数据资产公证（单条记录）",
                    "children": [
                        "前置条件：企业账号已认证、个人账号已登录",
                        "操作步骤：1.登录APP 2.进入数据资产对接页面 3.点击'发起数据资产公证' 4.上传数据资产列表截图 5.等待AI识别",
                        "【测试数据图片】火车票 - 详见下方图片文件夹",
                        "├─ 图片文件：1_data_asset/test_data/DAT-01_火车票.png",
                        "├─ 提示词文件：1_data_asset/test_data/DAT-01_火车票_提示词.md",
                ...
                },
                {
                    ...
                    "children": [
                        "前置条件：企业账号已认证、个人账号已登录",
                        "【测试数据图片】机票 - 1_data_asset/test_data/DAT-02_机票.png",
                        "【测试数据图片】酒店订单 - 1_data_asset/test_data/DAT-02_酒店订单.png",
                        "├─ 提示词(机票)：电子客票行程单，CA1234，北京首都机场T3→上海浦东机场，08:30起飞，10:45到达，公务舱，票价¥2180",
                        "├─ 关键字段(机票)：CA1234, 北京首都机场T3, 上海浦东机场, 08:30, 10:45, 公务舱, ¥2180",
                        "├─ 提示词(酒店)：酒店订单确认单，北京国际饭店，2026-04-03入住，2026-04-05离店，豪华双床房，入住人张三，总价¥1296",
                        "└─ 关键字段(酒店)：北京国际饭店, 2026-04-03, 2026-04-05, 豪华双床房, ¥1296",
                        "预期结果：AI识别出多条记录，材料清单显示全部记录"
                    ]
                }
            ]},
            {"title": "1.3 负向测试用例", "children": [
                {
                    "title": "DAT-05：上传不含有效信息的图片",
                    "children": [
                        "前置条件：个人账号已登录",
                        "【测试数据图片】风景图片 - 1_data_asset/test_data/DAT-05_风景图片.png",
                ...
                },
                {
                    ...
                    "children": [
                        "前置条件：个人账号已登录",
                        "【测试数据图片】营业执照 - 1_data_asset/test_data/DAT-06_营业执照.png",
    ...
    branches.append({
        ...
        "children": [
            ...
            {"title": "2.2 正向测试用例", "children": [
                {
                    "title": "AUTH-01：正常上传身份证进行实名认证",
                    "children": [
                        "前置条件：个人账号已登录、未认证",
                        "操作步骤：1.进入实名认证页面 2.点击'上传身份证' 3.拍摄/选择身份证照片 4.提交认证",
                        "【测试数据图片】身份证正面 - 2_identity/test_data/AUTH-01_身份证正面.png",
            ...
            {"title": "2.3 负向测试用例", "children": [
                {
                    "title": "AUTH-05：上传模糊的身份证照片",
                    "children": [
                        "前置条件：个人账号已登录",
                        "【测试数据图片】模糊的身份证 - 2_identity/test_data/AUTH-05_模糊的身份证.png",
                ...
                },
                {
                    ...
                    "children": [
                        "前置条件：个人账号已登录",
                        "【测试数据图片】营业执照 - 2_identity/test_data/AUTH-06_营业执照（非身份证）.png",
                ...
                },
                {
                    ...
                    "children": [
                        "前置条件：个人账号已登录",
                        "【测试数据图片】已过期的身份证 - 2_identity/test_data/AUTH-07_已过期的身份证.png",
                        "├─ 提示词：中华人民共和国居民身份证，姓名李四，有效期2015.01.01-2025.01.01（已过期）",
    ...
    branches.append({
        ...
        "children": [
            ...
            {"title": "3.2 正向测试用例", "children": [
                {
                    "title": "CERT-01：正常提交公证员资质申请",
                    "children": [
                        "前置条件：个人账号已登录、公证员角色",
                        "操作步骤：1.进入公证员资质申请页面 2.上传公证员执业证 3.上传任职证明 4.上传半身照 5.提交申请",
                        "【测试数据图片】公证员执业证 - 3_notary_qualification/test_data/CERT-01_公证员执业证.png",
    ...
    branches.append({
        ...
        "children": [
            ...
            {"title": "5.2 正向测试用例", "children": [
                {
                    "title": "AI-02：拍照上传材料",
                    "children": [
                        "前置条件：材料上传环节",
                        "【测试数据图片】身份证 - 5_smart_notary/test_data/AI-02_身份证_拍照素材.png",
                ...
                },
                {
                    ...
                    "children": [
                        "前置条件：材料上传环节",
                        "【测试数据图片】户口本 - 5_smart_notary/test_data/AI-03_户口本.png",
                ...
                },
                {
                    ...
                    "children": [
                        "前置条件：材料上传环节",
                        "【测试数据图片】出生医学证明 - 5_smart_notary/test_data/AI-04_出生医学证明.png",
                        "├─ 提示词：出生医学证明，新生儿王小明，男，2016年03月26日出生，出生地北京市海淀区妇幼保健院，父亲王五，母亲赵六",
                        "└─ 关键字段：王小明, 男, 2016年03月26日, 王五, 赵六",
                        "预期结果：文件上传成功，显示文件名称"
                    ]
                },
                {
                    ...
                    "children": [
                        "前置条件：材料上传环节",
                        "【测试数据图片】身份证 - 5_smart_notary/test_data/AI-06_身份证.png",
                        "【测试数据图片】户口本 - 5_smart_notary/test_data/AI-06_户口本.png",
                        "【测试数据图片】出生医学证明 - 5_smart_notary/test_data/AI-06_出生医学证明.png",
...
.image-info .prompt { background: #1a1a2e; padding: 12px; border-radius: 8px; color: #60a5fa; font-size: 13px; line-height: 1.6; margin-bottom: 10px; border-left: 3px solid #60a5fa; }
                    ...
                    html += f'''
                        <div class="image-card">
                            ...
                            <div class="image-info">
                                ...
                                <div class="prompt" style="display:none">{prompt_text}</div>
                                <div class="prompt-text">{prompt_text}</div>
                                <div style="margin-top:10px">
                                    <span style="color:#9ca3af;font-size:12px">关键字段：</span>
                                    {fields_html}
                                </div>
                            </div>
                        </div>'''
...
def main():
    ...
    xmind_path = os.path.join(OUTPUT_ROOT, "公证智能体四期测试功能点.xmind")
    ...
    print(f"[OK] 图片文件夹: {OUTPUT_ROOT}/各模块/test_data/")
    ...
    print(f"\n输出目录：{OUTPUT_ROOT}")
    print(f"\n生成文件：")
    print(f"  1. XMind文件：公证智能体四期测试功能点.xmind")
    print(f"     - 可用XMind软件打开")
    print(f"     - 包含测试数据图片路径和提示词")
    print(f"  2. HTML文件：公证智能体四期测试功能点_含图片.html")
    print(f"     - 直接在浏览器中打开")
    print(f"     - 图片直接嵌入，点击可放大")
    print(f"  3. 测试图片：各模块/test_data/*.png")
    print(f"     - 实际可用的测试图片文件")
    print(f"     - 每个图片配有提示词文件")
